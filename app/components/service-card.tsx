...
function ServiceCard({
  ...
  return (
    <div className="border-secondary group flex h-96 w-1/3 flex-col border transition duration-300 hover:border-gray-200">
      <div className="border-secondary relative flex h-32 flex-col border-b p-4">
        <h3 className="font-jura pb-2">{title}</h3>
        <p className="text-sm text-gray-400">{summary}</p>
      </div>
      <ul className="grow list-inside list-disc p-4 text-sm">
